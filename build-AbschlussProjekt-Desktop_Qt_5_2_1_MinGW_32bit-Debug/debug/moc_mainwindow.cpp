...
#include "../../AbschlussProjekt/mainwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_meinWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 36, 4)
    ...
    "meinWidget\0saveFile\0\0loadFile\0start\0"
    "stop\0"
};
...
const QMetaObject meinWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_meinWidget.data,
      qt_meta_data_meinWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_meinWidget.stringdata))
